...
#' Create a sequence of the stages across states
#'
#' This function creates a sequence
#'
#' @param df Input data
#' @param patid Subject Identifier
#' @param state State
#' @param stage Stage
#' @return Data frame
#' @export
...
window_to_stage <- function(df,pid=patid, start_date=start, STATE=state, end_date=end, gap=NA,gap_val = 'None',collapse = F){
  pid <- enquo(pid)
  STATE <- enquo(STATE)
